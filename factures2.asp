...
car = request.form("vehiculo")
 SQL = "Select * from `fichas` where `vehiculo` like '%"&car&"%'"
SQL2 = "Select * from `fichas` where `vehiculo` like '%"&car&"%'"
...
%>
	...
	<%response.write(car)%>
	<table width="1200" border="1" cellpadding="0" cellspacing="0" bgcolor="#003300">
      <tr>
        <td align="center"><span class="style1">FECHA</span></td>
        <td align="center"><span class="style1">LUGAR</span></td>
        <td align="center"><span class="style1">SERVICIO</span></td>
        <td align="center"><span class="style1">NO. FICHA </span></td>
	...
	wend
      ...
      <tr>
        ...
        <td align="center"><strong>=SUMA(F7:F<%response.Write(u)%>)</strong></td>
      </tr>
    </table>
</div>
<label>
