...
c = request.form("cambio")
 ...
 SQL5 = "UPDATE `combustible` set `lts` = '"&request.form("litros")&"'  WHERE `id` = '"&c&"'"
 SQL = "update `combustible` set `vehiculo` = '"&vehiculo&"' where `id` = '"&c&"'"
 SQL2 = "update `combustible` set `kmactuales` = '"&km&"' where `id` = '"&c&"'"
 SQL3 = "update `combustible` set `lugarvisita` = '"&lugar&"' where `id` = '"&c&"'"
 SQL4 = "update `combustible` set `asunto` = '"&asunto&"' where `id` = '"&c&"'"
 'SQL5 = "update `combustible` set `lts` = '"&litros&"' where `id` = '"&xxo&"'"
 SQL6 = "update `combustible` set `re` = '"&responsable&"' where `id` = '"&c&"'"
 SQL7 = "update `combustible` set `fe` = '"&fecha&"' where `id` = '"&c&"'"
 SQL8 = "update `combustible` set `depto` = '"&depa&"' where `id` = '"&c&"'"
 SQL9 = "update `combustible` set `tipo` = '"&tipo&"' where `id` = '"&c&"'"
