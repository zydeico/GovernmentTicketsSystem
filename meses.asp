...
<form id="form1" name="form1" method="post" action="meses2.asp">


  <table width="800" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <th bgcolor="#00FF00" scope="col"><span class="style11">Reportes por mes </span></th>
    </tr>
  </table>
    ...
    <tr>
      <th scope="col"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F2F2F2">
          ...
          <tr>
            ...
            <td width="100%" align="center">Departamento</td>
          </tr>
          <tr>
            <td width="0%" align="right">&nbsp;</td>
