      ...
      <td><table width="800" border="0" cellspacing="1" cellpadding="1">
        <tr>
          ...
          <br /><%
		   ...
		   SQL = "Select * from `combustible` where `fe` LIKE '%2009' order by `factura` DESC"
...
Set rs = conn.Execute(SQL)
		  ...
		  %>
		  <option value="<%response.Write(rs("factura"))%>"><%response.Write(rs("factura"))%>--<%response.Write(rs("depto"))%></option>
