            ...
            <tr>
              <td width="30%" bgcolor="#FFFFFF"><table width="900" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <td width="25%" rowspan="8" align="center" valign="top"><img src="bloc.jpg" width="170" height="215" /></td>
                    <td width="23%" align="right"><span class="style4"><strong>Veh&igrave;culo:</strong></td>
                  ...
                  <tr>
                    <td align="center" colspan="4"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                      <tr>
                       <!-- <td align="right"><img src="sudhlksdjhfkljasdhflkajsdhflkjshdhfieuwyr238273ofi.png" width="186" height="137" /></td>-->
                       <td align="center"><img src="_oficial.jpg" width="286" height="147" /></td>
                       <!-- <td align="left"><img src="2498237477987jhkjhsfdsello.png" width="186" height="137" /></td> -->
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
