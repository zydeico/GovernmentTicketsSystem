...
<title>MODIFICACION DE VALE DE COMBUSTIBLE</title>
<style type="text/css">
<!--
.boton {color:#000000; 
font-weight:bold; 
...
<body>
<form id="form1" name="form1" method="post" action="consulta2.asp">
  <table width="800" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <th bgcolor="#0000FF" scope="col"><span class="style11"><font color="#FFFFFF">MODIFICACION DE VALES DE COMBUSTIBLE</font></span></th>
    </tr>
  </table>
