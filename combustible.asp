...
<form id="form1" name="form1" method="post" action="altavalecom.asp" onSubmit = "return validar(this)">
  <table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td align="center" bgcolor="#0000FF"><span class="style1">Solicitud para Vales de Combustible</span></td>
    </tr>
  </table>
  <table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td><p align="center" class="style39 style37 style41"><strong>AVISO IMPORTANTE </strong></p>
      <p><span class="style39">A partir del lunes 12 de Octubre del 2015 y para  brindarte un mejor servicio la hora l&iacute;mite para</span><span class="style40"> <span class="style43">mandar y recoger</span> </span><span class="style39">vales de combustible es  a las 03:30 p.m. por  su comprensi&oacute;n gracias.</span></p></td>
    </tr>
  </table>
  <table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
