<form id="form1" name="form1" method="post" action="factures2.asp">
  <label>
...
<option value="PM.038">PM.038</option>
...
<option value="MOTOCONFORM">MOTOCONFORMADORA CATERPILLAR</option>
<option value="00-603">00-603</option>
<option value="00-607">00-607</option>
...
<option value="03-613">03-613</option>
...
<option value="GT285A1">GT285A1</option>
