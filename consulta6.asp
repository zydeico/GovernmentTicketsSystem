...
response.Write(xxo)
 ...
 SQL = "Select * from `combustible` where `fe` like '%05/2007'  order by depto asc, id asc"
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td align="center"><%response.write(popof)%></td>
    ...
    <td align="center"><%response.write(rs("lts"))
	...
	<td align="center"><%response.write(rs("fe"))%></td>
  </tr>
