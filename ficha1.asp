...
<body>
<%
xxo = request.form("ficha")


 SQL = "Select * from `fichas` where `id` = '"&xxo&"' order by id asc"
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>Cuenta:<span class="style17">
      <%
		
		 
		 response.Write(rs("cuenta"))
