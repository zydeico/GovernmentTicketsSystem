...
<form id="form1" name="form1" method="post" action="valef.asp">
  <table width="80%" border="0" align="center" cellpadding="4" cellspacing="4" bgcolor="#999999">
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>FOLIO DEL VALE 
          <label></label>
      </strong></td>
    ...
    <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>COSTO DEL VALE </strong></td>
      <td align="left" bgcolor="#FFFFFF"><label>
        <input name="costo" type="text" id="costo" />
      </label></td>
    </tr>
     <tr>
      <td align="right" bgcolor="#FFFFFF"><strong>LITROS SURTIDOS</strong></td>
      <td align="left" bgcolor="#FFFFFF"><label>
