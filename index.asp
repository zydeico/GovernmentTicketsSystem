...
<div id="content_middle">
  ...
  <div id="content_bottom">
		<div class="teaser_bottom">
		  ...
		  <br/>
		<!--N�heres erfahren Sie auch bei uns!-->
</div>
		<div class="hor_spacer">&nbsp;</div>
		<div class="teaser_bottom">
	...
	<div id="footer"><span class="style1">H. Ayuntamiento 2012 - 2015&nbsp;&nbsp;&nbsp;- Tel: ( 413) 16 6 00 28 ext. 105&nbsp;-&nbsp; Apaseo el Alto, 5 de mayo # 101, Colonia Centro.</span>
	  ...
	  <div class="style1" id="wrapper_impressum">
			...
			Gesch�ftsf�hrer: Fausto Maugeri<br/>
			USt-ID-Nr. DE 262 050 866<br/>
			<br/>
			</p>
			<div id="btn_close"><img src="design_images/spacer.gif" width="20" height="20" alt="Schlie�en" /></div>
		</div>
	</div>
	<div class="cleaner"></div>
  </div>
...
'para evitar la introducci�n de sentencias SQL
...
' con ello evitamos el ataque t�pico SQL
...
response.redirect "iniciosesion.html?msg=Usuario%20/%20password%20incorrecto"
end if
